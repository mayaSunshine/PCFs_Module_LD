export const getClosestPairDiffAndRange = (data)=>{
    if (data.length < 2) {
        return;
    }
...
export const calculateAppropriateBarWidth = (data, totalWidth, innerPadding)=>{
 ...
 */ export const calcTotalWidth = (containerWidth, margins, extraMargin = 0)=>{
 ...
 */ export const calcTotalBandUnits = (numBands, innerPadding)=>{
 ...
 */ export const calcRequiredWidth = (bandwidth, numBands, innerPadding)=>{
 ...
 */ export const calcBandwidth = (totalWidth, numBands, innerPadding)=>{
