...
exports.isScatterAreaChart = exports.getAxisKey = exports.getAxisIds = exports.mapFluentChart = exports.getValidSchema = exports.sanitizeJson = exports.isInvalidValue = exports.validate2Dseries = exports.isObjectArray = exports.isStringArray = exports.isYearArray = exports.isMonthArray = exports.isNumberArray = exports.isDateArray = exports.isArrayOfType = exports.isMonth = exports.isDate = exports.isNumber = void 0;
exports.isTypedArray = isTypedArray;
exports.isArrayOrTypedArray = isArrayOrTypedArray;
const DecodeBase64Data_1 = require("./DecodeBase64Data");
...
const isDateArray = (data) => {
    /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
    return (0, exports.isArrayOfType)(data, (value) => (0, exports.isDate)(value) || value === null);
};
exports.isDateArray = isDateArray;
const isNumberArray = (data) => {
    /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
    return (0, exports.isArrayOfType)(data, (value) => (typeof value === 'string' && (0, exports.isNumber)(value)) || typeof value === 'number' || value === null);
};
exports.isNumberArray = isNumberArray;
const isMonthArray = (data) => {
    /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
    return (0, exports.isArrayOfType)(data, (value) => (0, exports.isMonth)(value) || value === null);
};
exports.isMonthArray = isMonthArray;
const isYearArray = (data) => {
    /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
    return (0, exports.isArrayOfType)(data, (value) => isYear(value) || value === null);
};
exports.isYearArray = isYearArray;
const isStringArray = (data) => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return (0, exports.isArrayOfType)(data, (value) => typeof value === 'string' || value === null);
};
exports.isStringArray = isStringArray;
const isObjectArray = (data) => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return (0, exports.isArrayOfType)(data, (value) => typeof value === 'object' && value !== null && !isArrayOrTypedArray(value));
};
exports.isObjectArray = isObjectArray;
const validate2Dseries = (series) => {
...
exports.validate2Dseries = validate2Dseries;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
...
exports.getValidSchema = getValidSchema;
const validateSeriesData = (series, validateNumericY) => {
    if (!(0, exports.validate2Dseries)(series)) {
        throw new Error(`Invalid 2D series encountered.`);
    }
    if (validateNumericY && !(0, exports.isNumberArray)(series.y)) {
...
const validateBarData = (data) => {
    ...
    if (data.orientation === 'h') {
        if (!(0, exports.isNumberArray)(data.x) && !(0, exports.isDateArray)(data.x)) {
            throw new Error(`${UNSUPPORTED_MSG_PREFIX} ${data.type}, orientation: ${data.orientation}, string x values not supported.`);
        }
        if (!canMapToGantt(data) && (0, exports.isDateArray)(data.x)) {
        ...
        if (!(0, exports.isNumberArray)(data.y) && !(0, exports.isStringArray)(data.y) && !(0, exports.isObjectArray)(data.y)) {
...
const validateScatterData = (data, layout) => {
    ...
    if (isScatterMarkers(mode)) {
        ...
        if (!(0, exports.isNumberArray)(data.x) && !(0, exports.isStringArray)(data.x) && !(0, exports.isDateArray)(data.x)) {
            throw new Error(`${UNSUPPORTED_MSG_PREFIX} ${data.type}, mode: ${mode}, xAxisType: ${xAxisType}`);
        }
        if (!(0, exports.isNumberArray)(data.y) && !(0, exports.isStringArray)(data.y)) {
    ...
    const isAreaChart = (0, exports.isScatterAreaChart)(data);
...
const invalidateLogAxisType = (data, layout) => {
    const axisIds = (0, exports.getAxisIds)(data);
    return Object.keys(axisIds).some(axLetter => {
        var _a;
        const axisKey = (0, exports.getAxisKey)(axLetter, axisIds[axLetter]);
...
function findSankeyCycles(input) {
    ...
    (_d = (_c = input.link) === null || _c === void 0 ? void 0 : _c.value) === null || _d === void 0 ? void 0 : _d.forEach((val, idx) => {
        var _a, _b, _c, _d;
        if (!((0, exports.isInvalidValue)(val) || (0, exports.isInvalidValue)((_b = (_a = input.link) === null || _a === void 0 ? void 0 : _a.source) === null || _b === void 0 ? void 0 : _b[idx]) || (0, exports.isInvalidValue)((_d = (_c = input.link) === null || _c === void 0 ? void 0 : _c.target) === null || _d === void 0 ? void 0 : _d[idx]))) {
    ...
    function dfs(node, path) {
        if ((0, exports.isInvalidValue)(node) || !graph[node]) {
...
const DATA_VALIDATORS_MAP = {
    ...
    scatterpolar: [
        data => {
            if (!(0, exports.isNumberArray)(data.theta) && !(0, exports.isStringArray)(data.theta)) {
                throw new Error(`${UNSUPPORTED_MSG_PREFIX} ${data.type}, theta values must be array of numbers or strings`);
            }
            if (!(0, exports.isNumberArray)(data.r)) {
...
const mapFluentChart = (input) => {
    try {
        (0, exports.sanitizeJson)(input);
    }
    catch (error) {
        return { isValid: false, errorMessage: `Invalid JSON: ${error}` };
    }
    try {
        let validSchema = (0, exports.getValidSchema)(input);
        try {
            validSchema = (0, DecodeBase64Data_1.decodeBase64Fields)(validSchema);
        }
        catch (error) {
            ...
            switch (traceData.type) {
                ...
                case 'bar':
                    ...
                    if (barData.orientation === 'h') {
                        ...
                        if ((0, exports.isObjectArray)(barData.y)) {
                        ...
                        if (['group', 'overlay'].includes((_a = validSchema === null || validSchema === void 0 ? void 0 : validSchema.layout) === null || _a === void 0 ? void 0 : _a.barmode)) {
                            if (!(0, exports.isNumberArray)(barData.y)) {
                ...
                case 'scattergl':
                    ...
                    const isAreaChart = (0, exports.isScatterAreaChart)(scatterData);
...
exports.mapFluentChart = mapFluentChart;
const canMapToGantt = (data) => {
    return (0, exports.isDateArray)(data.base) || (0, exports.isNumberArray)(data.base);
};
const getAxisIds = (data) => {
    let xAxisId = 1;
...
exports.getAxisIds = getAxisIds;
const getAxisKey = (axLetter, axId) => {
    return `${axLetter}axis${axId > 1 ? axId : ''}`;
};
exports.getAxisKey = getAxisKey;
const isScatterAreaChart = (data) => {
    return data.fill === 'tonexty' || data.fill === 'tozeroy' || !!data.stackgroup;
};
exports.isScatterAreaChart = isScatterAreaChart;
const supportedScatterInLineChart = (data, layout) => {
    var _a;
    const isXDate = (0, exports.isDateArray)(data.x);
    const isXNumber = (0, exports.isNumberArray)(data.x);
    ...
    const isXYear = (0, exports.isYearArray)(data.x);
    const isXMonth = (0, exports.isMonthArray)(data.x);
    const isYString = (0, exports.isStringArray)(data.y);
    const axisIds = (0, exports.getAxisIds)(data);
    const xAxisKey = (0, exports.getAxisKey)('x', axisIds.x);
