...
exports.formatDateToLocaleString = exports.formatToLocaleString = void 0;
exports.handleFloatingPointPrecisionError = handleFloatingPointPrecisionError;
exports.getMultiLevelDateTimeFormatOptions = getMultiLevelDateTimeFormatOptions;
/**
 ...
 */
const formatToLocaleString = (data, culture, useUtc) => {
    ...
    if (typeof data === 'number') {
        ...
        return (0, exports.formatDateToLocaleString)(data, culture, useUtc ? true : false);
    }
    return data;
};
exports.formatToLocaleString = formatToLocaleString;
const DEFAULT_DATE_TIME_FORMAT_OPTION = {
 ...
 */
const formatDateToLocaleString = (date, culture, useUtc, showTZname = true, options) => {
    culture = culture || undefined;
 ...
 */
function getMultiLevelDateTimeFormatOptions(startLevel, endLevel) {
    ...
    const S = MS_S;
    const S_MIN = MS_S_MIN;
    const S_MIN_H = MS_S_MIN_H;
