...
exports.decodeBase64Fields = decodeBase64Fields;
const PlotlySchemaConverter_1 = require("./PlotlySchemaConverter");
...
function decodeBase64FromString(base64String) {
        ...
        for (const item of plotlySchema.data || []) {
            ['y', 'x', 'z', 'r', 'theta', 'values'].forEach(key => {
                if (item[key] &&
                    ...
                    let shape = item[key].shape;
                    // convert to an array if shape is a string
                    if (typeof shape === 'string') {
                        let parsedShape = undefined;
                        try {
                            // Try to parse as JSON array
                            parsedShape = JSON.parse(shape);
                            if (!(0, PlotlySchemaConverter_1.isArrayOrTypedArray)(parsedShape)) {
                    ...
                    if (shape !== undefined && (0, PlotlySchemaConverter_1.isArrayOrTypedArray)(shape)) {
                        item[key] = reshapeArray(bdata, shape);
                    }
                    else {
                        item[key] = bdata;
                    }
...
//# sourceMappingURL=DecodeBase64Data.js.map